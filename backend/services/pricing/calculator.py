# backend/services/pricing/calculator.py
class PricingCalculator:
    ...
    @classmethod
    def calculate(cls, module_count: int, is_free: bool = False) -> dict:
        """Return dictionary with price_zar and price_usd."""
        if is_free or module_count <= 0:
